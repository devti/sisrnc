...
public class UsuarioDAO {
	...
	public int insertUsuario(Usuario usuario){
		...
		if(JOptionPane.showConfirmDialog(null, "tem certeza que quer cadastrar o usuário: "+usuario.getLogin()+"?"
		...
		String query = "INSERT INTO USUARIO(LOGIN, SENHA) VALUES (?, ?, ?) ";
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "Usuário: "+usuario.getLogin()+" cadastrado com sucesso", "Cadastrado com sucesso", JOptionPane.INFORMATION_MESSAGE);
